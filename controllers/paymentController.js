...
exports.initializePayment = async (req, res) => {
  try {
    ...
    if (amount === 0) {
      ...
      return res.json({ success: true, ticket, message: "Free ticket registered successfully" });
    }

    // PAID ticket flow: Initialize Paystack payment
    const paystackResponse = await axios.post(
      `${PAYSTACK_BASE_URL}/transaction/initialize`,
      { email, amount: amount * 100, metadata: { eventId, ticketType, userId } },
